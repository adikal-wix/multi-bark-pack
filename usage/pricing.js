 ...
 * @param {string} backend - Backend name (e.g. 'codex', 'gemini')
 * @param {object} usage - Token usage object { input_tokens, output_tokens, cached_input_tokens? }
 * @returns {{ costUsd: number, estimated: true }|null} Estimated cost or null if cannot estimate
 */
function estimateCost(backend, usage) {
